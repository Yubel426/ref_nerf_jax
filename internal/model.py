...
class MLP(nn.Module):
    ...
    use_directional_enc: bool = True  # If True, use IDE to encode directions.
    ...
    use_n_dot_v: bool = True  # If True, feed dot(n * viewdir) to 2nd MLP.
    ...
    def setup(self):
        ...
        self.dir_enc_fn = utils.generate_ide_fn(self.deg_view)
    ...
    """
        ...
        if self.disable_rgb:
            ...
            if viewdirs is not None:
                ...
                refdirs = utils.reflect(-viewdirs[..., None, :], normals_to_use)
